...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const perhiasanInput = document.getElementById('perhiasan');
            const hargaEmasInput = document.getElementById('hargaEmas');
            ...
            function updateInputValue(inputElement, includeDecimals = true, isGram = false) {
                let value = inputElement.value.replace(/\D/g, '');
                value = isNaN(value) || value === '' ? 0 : parseInt(value);
                const formattedValue = isGram ? `${value} gram` : formatToCurrency(value, includeDecimals);
                inputElement.value = formattedValue;
            }

            emasInput.addEventListener('input', function() {
                updateInputValue(this, true, true);
            });

            perhiasanInput.addEventListener('input', function() {
                updateInputValue(this, true, true);
            });
            ...
            document.querySelector('.button').addEventListener('click', function() {
                ...
                const perhiasan = parseFloat(perhiasanInput.value.replace(/\D/g, '')) || 0;
                const hargaEmas = parseFloat(hargaEmasInput.value.replace(/\D/g, '')) || 0;

                const total = (emas * hargaEmas) + (perhiasan * hargaEmas);
        ...
        <div class="container py-5">
            <div class="row g-4 footer-inner">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <a class="text-body mb-2" href="/#Donasi"><i class="fa fa-check text-primary me-2"></i>Donasi</a>
                    ...
                    <a class="text-body mb-2" href="/#Team"><i class="fa fa-check text-primary me-2"></i>Our
                        Team</a>
                    <a class="text-body mb-2" href="/#Kontak"><i class="fa fa-check text-primary me-2"></i>Kontak</a>
                </div>
            </div>
        </div>
