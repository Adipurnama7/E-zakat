                    ...
                    <div class="navbar-nav ms-lg-auto mx-xl-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 rounded-0">
                                ...
                                <a href="/zakat_maal" class="dropdown-item">Maal Zakat</a>
                                <a href="/perdagangan" class="dropdown-item">Comerscial Zakat</a>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-header-inner animated zoomIn">
                        ...
                        <h2 class="display-1 mb-5 text-dark">Clean Our Treasure and Purify the Soul</h2>
                        <a href="index.html#Donasi" class="btn btn-primary py-3 px-5">Donation</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-5 mb-5">
                ...
                <div class="col-xl-6 wow fadeIn" data-wow-delay="0.5s" id = "Tentang">
                    <p class="fs-5 text-uppercase text-primary">About E-Zakat</p>
                    <h1 class="display-5 pb-4 m-0">What is E-Zakat ?</h1>
                    <p class="pb-4">e-Zakat is a platform in the field of zakat management whose hope is
                        This platform can help and is of course useful for everyone to make things easier
                        distribution</p>
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            <div class="ps-3 d-flex align-items-center justify-content-start">
                                ...
                                <div class="ms-4">
                                    <h5>Zakat</h5>
                                    <p>a certain part of the assets that every Muslim must pay if
                                        has achieved the specified requirements.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="ps-3 d-flex align-items-center justify-content-start">
                                ...
                                <div class="ms-4">
                                    <h5>Recipient Zakat</h5>
                                    <p>Fakir, Poor, Amil, Convert, Riqab, Gharimin, Fisabillilah, Ibnu Sabil</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Zakat Maal</p>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-2"><i class="fa fa-check text-primary me-3"></i>Zakat Income</p>
                            <p class="mb-0"><i class="fa fa-check text-primary me-3"></i>Zakat Gold</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid event py-5" id= "Informasi">
        <div class="container py-5">
            ...
            <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.1s">
                ...
                <div class="col-9 col-lg-6 border-start border-dark pb-5">
                    <div class="ms-3">
                        ...
                        <p class="mb-4">Zakat is obligatory on every soul of both Muslim men and women
                            carried out in the month of Ramadan </p>
            ...
            <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.3s">
                <div class="col-3 col-lg-2 pe-0">
                    <div class="text-center border-bottom border-dark py-3 px-2">
                        <h6>Meanwhile, zakat mal must be issued when assets have reached the nishab and have
                            One Hijri year passed</h6>
                    </div>
                </div>
                <div class="col-9 col-lg-6 border-start border-dark pb-5">
                    <div class="ms-3">
            ...
            <div class="row g-4 event-item wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="col-9 col-lg-6 border-start border-dark pb-5">
                    <div class="ms-3">
                        ...
                        <br>
                        <p>Meanwhile, the conditions for zakat fitrah are as follows
                            Muslim
                            live during the month of Ramadan
                            has excess basic necessities for the evening and Eid al-Fitr</p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="bradcam_text text-center">
                        <h3>Donation</h3>
                        <h4>Account Number BRI Bank: 377401031817501 on behalf of Angga Gustian</h4>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-sm-4 mb-3" style="border: 2px solid black; border-radius: 10px;">
                                    <div class="form-group">
                                        <input class="form-control valid" name="No_Hp"
                                            placeholder="Enter Your Cellphone Number" required="" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-4 mb-3" style="border: 2px solid black; border-radius: 10px;">
                                    <div class="form-group">
                                        <input class="form-control valid" name="Tanggal_Donasi"
                                            placeholder="Date Donation" required="" type="date">
                                    </div>
                                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 col-xl-7">
                    <div class="team-item wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">This group aims to introduce E-Zakat which facilitates
                            zakat management and online zakat payments. The presentation will cover the features
                            main points, advantages, and how to use the platform to give zakat easily and
                            efficient</p>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-4">
