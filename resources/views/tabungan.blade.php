...
<body>
    ...
    <div class='kalkulator'>
        <div class='kalkulator-container'>
            ...
            <div class='kalkulator-right'>
                <label>Saldo Awal (awal hitungan tahun) (IDR): </label>
                <input id="awal" type="text" class="form-control"
                    placeholder="Masukkan saldo awal satu tahun terakhir">
                <label>Saldo Akhir (akhir hitungan tahun) (IDR): </label>
                <input id="akhir" type="text" class="form-control"
                    placeholder="Masukkan saldo akhir satu tahun terakhir">
                <label>Jumlah Saldo Satu Tahun Terakhir (IDR): </label>
                ...
                <label>Besar Nisab Tabungan / Tahun (IDR): </label>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            akhirInput.addEventListener('input', function() {
                updateInputValue(this);
            });
