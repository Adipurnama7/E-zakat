    ...
    <div class='kalkulator'>
        <div class='kalkulator-container'>
            ...
            <div class='kalkulator-right'>
                <label>Modal (dalam bentuk stok barang) (IDR): </label>
                <input id="modal" type="text" class="form-control"
                    placeholder="Masukkan modal sesuai harga jual">
                <label>Bahan Baku Produksi (harga beli bahan) (IDR): </label>
                <input id="produksi" type="text" class="form-control"
                    placeholder="Masukkan bahan baku produksi sesuai harga beli">
                <label>Keuntungan / Tahun (IDR): </label>
                <input id="untung" type="text" class="form-control"
                    placeholder="Masukkan laba yang diperoleh">
                <label>Piutang Lancar (bisa ditagih kepastiannya) (IDR): </label>
                <input id="piutang" type="text" class="form-control"
                    placeholder="Masukkan piutang kategori bisa ditagih">
                <label>Hutang / Kewajiban Perusahaan (IDR): </label>
                <input id="hutang" type="text" class="form-control"
                    placeholder="Masukkan hutang atau kewajiban perusahaan">
                <label>Jumlah Harta Perusahaan (IDR): </label>
                ...
                <label>Besar Nisab Perusahaan / Tahun (IDR): </label>
